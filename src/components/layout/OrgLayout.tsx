...
const navItems = [
  ...
  },
  {
    ...
    icon: 'M9 19v-6a2 2 0 012-2h2a2 2 0 012 2v6m-6 0h6m-6 0H5a2 2 0 01-2-2V9a2 2 0 012-2h1m14 12h1a2 2 0 002-2V9a2 2 0 00-2-2h-1m-14 0V5a2 2 0 012-2h10a2 2 0 012 2v2M7 7h10',
  },
  {
    to: '/org/truck-types',
    label: 'Truck Types',

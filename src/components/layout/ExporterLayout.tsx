...
import { ExporterBottomNav } from '../exporter/ExporterBottomNav'

const desktopNav = [
  { to: '/exporter', label: 'Dashboard', end: true },
  { to: '/exporter/jobs', label: 'My Jobs', end: false },
  { to: '/exporter/jobs/new', label: 'Post Job', end: false },
  { to: '/exporter/profile', label: 'Profile', end: false },
]

export function ExporterLayout() {
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-blue-100/70">
              {organization?.name || 'Independent exporter'}
            </p>
          </div>
          <button
            type="button"

...
export function ExporterLoadPostingDetailPage() {
  ...
  useEffect(() => {
    ...
    void Promise.resolve()
      ...
      .catch((err) => {
        if (active) setError(err instanceof Error ? err.message : 'Failed to load posting')
      })
      .finally(() => {
